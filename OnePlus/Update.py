...
imei = config['IMEI']['imei']

url = 'http://otag.h2os.com/post/Query_Update'
headers = {'User-Agent': 'com.oneplus.opbackup/1.4.0.171219144846.50044e6',
           'Content-Type': 'application/json'}
body_A = {'version': '1', 'mobile': 'ONEPLUS A3010', 'ota_version': version_a, 'imei': imei,
          'mode': '0', 'type': '1', 'language': 'zh-CN', 'beta': '0', 'isOnePlus': '1'}
body_X = {'version': '1', 'mobile': 'ONEPLUS A3010', 'ota_version': version_x, 'imei': imei,
          'mode': '0', 'type': '1', 'language': 'zh-CN', 'beta': '0', 'isOnePlus': '1'}
body_W = {'version': '1', 'mobile': 'ONEPLUS A3010', 'ota_version': version_w, 'imei': imei,
          'mode': '0', 'type': '1', 'language': 'zh-CN', 'beta': '0', 'isOnePlus': '1'}
